...
#$category->listings()->isLive(); //grabs all listings of certain live categories
...
use Laravel\Scout\Searchable;// trait
...
class Listing extends Model
{
    ...
    //check if a user has faved something
    public function favouritedBy(User $user)
    {
        return $this->favourites->contains($user);
    }

    public function viewedUsers() //users that have seen this listing
    {
