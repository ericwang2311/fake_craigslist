...
//when user clicks an area, accesses AreaController
//user.area.store is put into home.blade.php


Route::get('/braintree/token', 'BraintreeController@token');

Route::group(['prefix' => '/{area}'], function () { // any app groups that need an area go into here
    ...
    Route::group(['prefix' => '/categories'], function () {
        ...
        Route::group(['prefix' => '/{category}'], function () {
            Route::get('/listings', 'Listing\ListingController@index')->name('listings.index'); //fetch listings under a certain category
        });
    });
    ...
    Route::group(['prefix' => '/listings', 'namespace' => 'Listing'], function () {
        ...
        Route::get('/{listing}/favourites', 'ListingFavouriteController@store')->name('listings.favourites.store');
        Route::delete('/{listing}/delete/favourites', 'ListingFavouriteController@destroy')->name('listings.favourites.destroy');//*
